...
`data` is the **canonical public UTM campus-data, provenance, and reuse surface** of the six-repository Gapwise ecosystem. It owns public campus facts and geometry; it does not redefine deterministic product calculations or public API behavior.
...
| Native Android | `Gapwise-for-UTM/android` | consumes Gapwise API/product contracts; it must not maintain a parallel UTM dataset |
...
1. Canonical public campus records originate in `data/data/utm`.
...
7. A schema/data-version change should trigger review of core API/SDK output, developer docs, Android consumers, AI grounding, and relevant status probes.
...
The ecosystem is intentionally interconnected, but ownership stays explicit: **Data owns public UTM facts; Core owns deterministic calculations/contracts; Docs explains releases; Android consumes; AI exposes bounded context; Status communicates health.**
