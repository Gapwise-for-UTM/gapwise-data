    ...
    <>
      ...
      <main id="top">
        <section className="hero shell">
          ...
          <p className="lead">The canonical UTM campus data layer behind Gapwise: first-party downloads, provenance, schemas, validation, attribution, and transparent uncertainty.</p>
